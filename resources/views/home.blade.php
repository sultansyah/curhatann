            ...
            <div class="basis-2/4">
                <div class="max-w-7xl mx-20 sm:px-2 lg:px-2">
                    ...
                    <div id="toast-success{{$curhatan->id}}"
                        ...
                        <!-- isi -->
                        <div
                            class="p-4 bg-white rounded-lg border-white font-normal dark:text-black dark:bg-white dark:border-white">
                        ...
                        <!-- isi -->
                        <button type="button"
                            class="closeToast ml-auto bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-500 inline-flex h-8 w-8 dark:text-gray-500 dark:bg-white dark:hover:bg-gray-200"
                        ...
                        <button type="button"
                            class="openModalUpdate  bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-500 inline-flex h-8 w-8 dark:text-gray-500 dark:bg-white dark:hover:bg-gray-200"
                            data-dismiss-target="#toast-success" aria-label="Close">
